...
### Fixed
- **Fixed the shortcut recorder crash in signed app bundles.** Opening Settings → Instructions or
  dictation shortcut setup no longer traps in the packaged app; shortcut recording now works from the
